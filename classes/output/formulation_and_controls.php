    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach ($order as $rowindex => $rowid) {
            ...
            foreach ($question->cols as $colid => $col) {
                $cellname = $this->qa->get_field_prefix() . $question->key($rowindex, $colindex);
                ...
                if ($showfeedback) {
                    ...
                    // Don't display a not selected cell would be incorrect anyway.
                    // Just display whether a not selected cell would be the correct one.
